...
grant execute on function public.award_profile_win(text, text) to anon, authenticated;
grant execute on function public.apply_correct_answer_reward(text, text, integer) to anon, authenticated;
