  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center overflow-hidden bg-black/90 p-4 backdrop-blur-md animate-fade-in">
      <div className="relative flex h-[90vh] w-full max-w-7xl flex-col overflow-hidden rounded-[32px] border border-surface/80 bg-app shadow-[0_35px_120px_rgba(0,0,0,0.48)]">
        ...
        <div className="relative grid min-h-0 flex-1 gap-0 xl:grid-cols-[300px_minmax(0,1fr)_330px]">
          <aside className="flex min-h-0 flex-col gap-5 border-b border-surface/70 p-5 sm:p-6 xl:border-b-0 xl:border-r">
            <div className="overflow-hidden rounded-[28px] border border-surface/80 bg-black/20 p-5 backdrop-blur-md">
              ...
              <div className="mt-4 flex items-start gap-4">
                <div className="relative overflow-hidden rounded-[24px] border border-primary/25 bg-panel/70 p-3 shadow-[0_18px_40px_rgba(0,0,0,0.35)]">
                  <img
